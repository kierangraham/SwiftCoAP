...
@objc public protocol SCClientDelegate {
...
public class SCClient: NSObject {
    ...
    public init(delegate: SCClientDelegate?) {
        self.delegate = delegate
    }

    public func sendCoAPMessage(message: SCMessage, hostName: String, port: UInt16) {
    ...
    public func sendWithRentransmissionHandling() {
        sendPendingMessage()
    ...
    public func notifyNoResponseExpected() {
        closeTransmission()
